...
const Applicants: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    e.preventDefault();
     ...
     const to = "zgju9781@gmail.com";
        const subject = "add Employee";
        const text =
          "We noticed a seeing to your Employee.\n" +
  ...
  useEffect(() => {
    const fetchDataAndSendEmail = async () => {
      try {
        ...
        const text =
          "We noticed a seeing to your Applicant.\n" +
          "Time: Tuesday, July 29, 2025 – 10:42 AM\n" +
          "Location: Addis Ababa, Ethiopia (approximate)";
  ...
  <select
    ...
    required
  >
    <option value="" className='text-gray-800'>Select Job Type</option>
    ...
    <option value="Night shift" className='text-gray-800'>Night shift</option>
  </select>
  {errors.jobType && (
    <p className="mt-1 text-sm text-red-600">{errors.jobType}</p>
                 ...
                 <div>
                  ...
                  >
                    <option value="Review " className='text-gray-800'>Review</option>
